          ...
          <div className="border-t border-[#2a3548] pt-4 mb-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span>Až {SUBSCRIPTION_LIMITS.free.maxBooks} knih</span>
              </li>
              <li className="flex items-start">
                <div className="w-5 h-5 flex-shrink-0 flex items-center justify-center mr-3 mt-0.5">
                  <svg
          ...
          <div className="border-t border-[#2a3548] pt-4 mb-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span>Až {SUBSCRIPTION_LIMITS.basic.maxBooks} knih</span>
              </li>
              <li className="flex items-start">
                <div className="w-5 h-5 flex-shrink-0 flex items-center justify-center mr-3 mt-0.5">
                  <svg
          ...
          <div className="border-t border-[#2a3548] pt-4 mb-4">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span>Pokročilé statistiky a analýzy</span>
              </li>
              <li className="flex items-start">
                <div className="w-5 h-5 flex-shrink-0 flex items-center justify-center mr-3 mt-0.5">
                  <svg
                ...
                <span>Exporty dat a PDF reporty</span>
              </li>
              <li className="flex items-start">
                <div className="w-5 h-5 flex-shrink-0 flex items-center justify-center mr-3 mt-0.5">
                  <svg
