              ...
              >
                <div className="container max-w-7xl mx-auto px-6 sm:px-8">
                  <div className="text-center mb-10 sm:mb-16">
                    ...
                    >
                      Vše, co potřebujete pro efektivní organizaci povinné četby
                      a přípravu do školy
                    </motion.p>
                  </div>
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        ...
                        <p className="text-sm sm:text-base text-muted-foreground">
                          ...
                          autorech pro rychlejší a efektivnější přípravu na
                          testy.
                        </p>
                      </div>
                    </motion.div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          knihovny, vytvářet manuální poznámky ke knihám a
                          využít 3 AI kredity měsíčně pro generování shrnutí. Je
                          ideální pro studenty, kteří potřebují spravovat menší
                          množství čtenářských zápisků a občas využít AI
                          asistenci.
                        </p>
                      </div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          kreditů měsíčně, základní AI shrnutí autorů a jejich
                          děl a export poznámek do PDF. Premium plán (79
                          Kč/měsíc) poskytuje neomezený počet knih, 100 AI
                          kreditů měsíčně, pokročilá AI shrnutí s delším
                          rozsahem a analýzou postav, rozšířené informace o
                          autorech včetně literárního kontextu a možnost
                          přizpůsobení AI shrnutí podle vašich potřeb.
                        </p>
                      </div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          platbě. Basic plán vás vyjde na 39 Kč měsíčně (místo
                          49 Kč) a Premium plán na 63 Kč měsíčně (místo 79 Kč).
                          Roční předplatné se platí jednorázově na celý rok
                          dopředu.
                        </p>
                      </div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          vytvoření strukturovaného shrnutí díla nebo informací
                          o autorovi. Každé vygenerování shrnutí spotřebuje
                          jeden AI kredit. Bezplatná verze nabízí 3 kredity
                          měsíčně, Basic plán 50 kreditů měsíčně a Premium plán
                          100 kreditů měsíčně. Premium plán navíc poskytuje
                          pokročilá AI shrnutí s delším rozsahem a analýzou
                          postav, rozšířené informace o autorech a možnost
                          přizpůsobit styl a zaměření shrnutí podle vašich
                          potřeb.
                        </p>
                      </div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Ano, neustále pracujeme na vylepšení aplikace. V
                          blízké budoucnosti plánujeme přidat sdílení poznámek
                          se spolužáky, pokročilejší AI analýzy a další funkce
                          pro usnadnění studia. Uživatelé Premium plánu získají
                          k těmto funkcím přístup jako první.
                        </p>
                      </div>
                    </motion.div>
                  </div>
